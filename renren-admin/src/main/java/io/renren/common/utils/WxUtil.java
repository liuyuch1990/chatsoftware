...
public class WxUtil {
    ...
    public static String sendTextMsg(Map<String,String> requestMap,String content){
        ...
        Map<String,Object> map=new HashMap<String, Object>();
        map.put("ToUserName", requestMap.get(Constants.FromUserName));
        map.put("FromUserName",  requestMap.get(Constants.ToUserName));
        map.put("MsgType", Constants.RESP_MESSAGE_TYPE_TEXT);
